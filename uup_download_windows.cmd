@echo off
:: Generated on 2026-08-25 00:01:06 GMT
...
:START_PROCESS
title 28000.2704_amd64_zh-cn_professional_312f676b download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=312f676b-2cbe-41aa-ba85-85c09c88518c&pack=zh-cn&edition=professional&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
